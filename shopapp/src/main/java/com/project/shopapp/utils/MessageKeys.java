...
public class MessageKeys {
    ...
    public static final String PASS_WORD_NOT_MATCH = "user.register.password_not_match";
    ...
    public static final String PLOAD_FILE_MUST_BE_IMAGE = "product.upload_images.file_must_be_image";

    public static final String INSERT_CATEGORY_FAILED = "category.create_category_create_failed";
